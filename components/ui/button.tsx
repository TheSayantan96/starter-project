  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-tm-full border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/30 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        "glass-adaptive":
          "relative isolate text-foreground border-[color-mix(in_srgb,var(--foreground)_18%,transparent)] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--surface-raised)_82%,transparent),color-mix(in_srgb,var(--surface-sunken)_68%,transparent))] shadow-[inset_0_1px_0_color-mix(in_srgb,white_72%,transparent),inset_0_-1px_0_color-mix(in_srgb,var(--foreground)_8%,transparent),0_5px_0_-3px_color-mix(in_srgb,var(--foreground)_18%,transparent),0_8px_18px_color-mix(in_srgb,var(--foreground)_12%,transparent)] backdrop-blur-[14px] backdrop-saturate-[1.2] hover:bg-[linear-gradient(180deg,color-mix(in_srgb,var(--surface-raised)_94%,transparent),color-mix(in_srgb,var(--surface-sunken)_76%,transparent))] hover:-translate-y-px",
      },
      size: {
